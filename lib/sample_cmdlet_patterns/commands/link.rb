...
module SampleCmdletPatterns
  module Commands
    ...
    class Link < SampleCmdletPatterns::Command
      ...
      # Execute Link command taking input from a input stream
      ...
      def execute(input: $stdin, output: $stdout)
        loop do
          ...
          when :gui
            gui
          when :hyperlink
            require_relative 'link_hyperlink'
            subcmd = SampleCmdletPatterns::Commands::LinkHyperlink.new({})
          else
            break
          end
      ...
      def gui
        ...
        begin
          ...
          command = SampleCmdletPatterns::Commands::Link.new(subcommand, {})
